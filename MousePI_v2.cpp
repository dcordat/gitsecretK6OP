...
int main(int argc, char** argv)
{
    ...
    while(cap.isOpened())
    {
		...
		if(dureeLastMove >= 1) 
	        	sendVide();
        //Tracking---------------------------------- A ISOLER ET ARRANGER
        
        system ("./Tracking");
        // Apparemment ce doit �tre un ex�cutable DONC faut regarder
        // comment on se d�brouiller avec un .cpp
        // Et comment on rentre les arguments
        // Et comment on r�cup�re le reste
